...
PM_START = """
Hey! {}, IM {}!
Product Your Group 🌐 Safe With Me!
...
HELP_STRINGS = """
Hello there! It's *{}*.
*Soul Queen Bot* with advanced features. 
*Main* commands available:
💠 - /start: _start the bot_
💠 - /help: _PM's you this message._
💠 - /help <module name>: _PM's you info about that module._
💠 - /donate: _information about how to donate!_
💠 - /settings:
  ✨ - _in PM: will send you your settings for all supported modules._
  ✨ - _in a group: will redirect you to pm, with all that chat's settings._
