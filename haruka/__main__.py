...
💠உங்கள் குழுவில் சேர்த்து என்னுடன் மகிழுங்கள்! ... ❤️_
"""


HELP_STRINGS = """
வணக்கம்!(•◡•)\n நான் [𒆜𝔾𝕣𝕠𝕦𝕡 𝕄𝕠𝕟𝕚𝕥𝕠𝕣𒆜](https://telegra.ph/file/3d0990a1b035fc644e147.jpg)
_நான் உங்களுக்கு உதவக் கூடிய வகையிலான Commands கீழே கொடுக்கப்பட்டுள்ளது._
*Main* commands available:
  🛡 - /start: bot தொடங்க,
  💎 - /help: எனது Commands,
  💬 - Give Your Feedback To My Owner [iMvEtRi](https://t.me/iMvEtRi)
  👨🏻‍💻 - /source: Information about my source.
{}
பின்வருபவை:
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "\nஅனைத்து commands-களையும் / or ! இட்டு பயன்படுத்தலாம்.\n")
...
using the python-telegram-bot library, and am now private source!😁
Visit: [here](https://github.com/IVETRI/)
❄ If You Want Clone This Bot contact my Developer : [Here](https://t.me/IMVETRI)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/71c30beb2523c2a220a98.jpg"
else:
  img = START_IMG    
